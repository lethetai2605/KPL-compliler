...
struct ConstantValue_ {
  ...
  union {
    int intValue;
    char charValue;
    char stringValue[MAX_LENGTH];     // TODO: Lưu constantValue kiểu string
    double doubleValue;               // TODO: Lưu constantValue kiểu double
  };
};
...
// TODO
ConstantValue* makeStringConstant(char str[MAX_LENGTH]);   // TODO
ConstantValue* makeDoubleConstant(double d);              // TODO
