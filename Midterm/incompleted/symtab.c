...
Type* charType;
// TODO
Type* stringType;   // TODO: Thêm khởi tạo stringType sử dụng trong parse.c
Type* doubleType;   // TODO: Thêm khởi tạo doubleType sử dụng trong parse.c
...
// TODO
Type* makeStringType(void) {        // TODO
  Type* type = (Type*) malloc(sizeof(Type));
  type->typeClass = TP_STRING;
  return type;
}
Type* makeDoubleType(void) {        // TODO
  Type* type = (Type*) malloc(sizeof(Type));
...
// TODO: MakeStringConstant
ConstantValue* makeStringConstant(char str[MAX_LENGTH]) {    
  ConstantValue* value = (ConstantValue*) malloc(sizeof(ConstantValue));
  value->type = TP_STRING;
  strcpy(value->stringValue, str);
  return value;
}
// TODO: MakeDoubleConstant
...
// TODO: Them xu ly duplicate 2 kieu moi
...
// TODO
  stringType = makeStringType();      // khoi tạo stringType
  doubleType = makeDoubleType();      // khoi tao doubleType
}
...
void cleanSymTab(void) {
  ...
  freeType(intType);
  freeType(charType);
  freeType(stringType);         // TODO: Free stringType
  freeType(doubleType);         // TODO: Free doubleType
}
