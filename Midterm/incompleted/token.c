...
struct {
  ...
  {"INTEGER", KW_INTEGER},
  {"CHAR", KW_CHAR},
  {"STRING", KW_STRING},    //TODO
  {"DOUBLE", KW_DOUBLE},    //TODO
  {"ARRAY", KW_ARRAY},
  {"OF", KW_OF},
...
char *tokenToString(TokenType tokenType) {
  ...
  case TK_STRING: return "a string";          // TODO
  case TK_DOUBLE: return "a double number";   // TODO
  ...
  case KW_STRING: return "keyword STRING";    // TODO
  case KW_DOUBLE: return "keyword DOUBLE";    // TODO
