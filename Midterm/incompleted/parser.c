...
// TODO
extern Type* stringType;    // TODO: extern từ file semantics.c
extern Type* doubleType;    // TODO: extern từ file semantics.c
...
ConstantValue* compileConstant(void) {
  ...
  switch (lookAhead->tokenType) {
    ...
    case SB_MINUS:
      eat(SB_MINUS);
      constValue = compileConstant2();
      if( constValue->type == TP_INT){    // TODO: Check them kieu double
...
Type* compileType(void) {
  ...
  case KW_CHAR: 
    ...
    type = makeCharType();
    break;
  case KW_STRING:         // TODO: Them 2 keyword moi
    eat(KW_STRING); 
    type = makeStringType();
    break;
  case KW_DOUBLE:        // TODO: Them 2 keyword moi
    eat(KW_DOUBLE); 
    type = makeDoubleType();
    break;
  case KW_ARRAY:
...
Type* compileBasicType(void) {
  ...
  case KW_CHAR: 
    ...
    type = makeCharType();
    break; 
  case KW_STRING:         // TODO: make them StringType 
    eat(KW_STRING); 
    type = makeStringType();
    break;
  case KW_DOUBLE:         // TODO: make them DoubleType 
    eat(KW_DOUBLE); 
    type = makeDoubleType();
    break;
  default:
...
// TODO:B2 => check type cua cac gia tri truyen vap cho ham cong hoac tru
...
// TODO:B2 => Sua de check cong dc cac kieu bien
Type* compileExpression2(void) {  // kiem tra type cua cac phan tu cua phep cong hoac tru
  Type* type1;
  Type* type2;
  type1 = compileTerm(); 
  ...
  if (type2 == NULL) return type1;
    ...
    if (type2->typeClass == TP_DOUBLE)  return type2;
    return type1;
  }
}

// TODO         // lay dau + va lay tung toan hang phia sau
Type* compileExpression3(void) {
  ...
  switch (lookAhead->tokenType) {
    ...
    case KW_THEN:
    case KW_WHILE:        // TODO
    case KW_BEGIN:        // TODO: them follow begin for switch-case
      return NULL;
      break;
    default:
...
// TODO 
Type* compileTerm2(void) {     // lay cac phan tu tiep theo cua cac phep toan * va /
  Type* type1;
  Type* type2;
...
Type* compileFactor(void) {
  ...
  case TK_STRING:            // TODO: Check token double
    eat(TK_STRING);
    type = stringType;
    break;

  case TK_DOUBLE:           // TODO: Check token double
    eat(TK_DOUBLE);
    type = doubleType;
    break;
  ...
  case TK_IDENT:
    ...
    case OBJ_CONSTANT:
      if(obj->constAttrs->value->type == TP_INT){
        ...
        type = charType;
      } else if(obj->constAttrs->value->type == TP_DOUBLE){   //TODO
        type = doubleType;
      } else{
        type = stringType;
      }  // 
