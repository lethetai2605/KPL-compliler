...
struct ErrorMessage errors[32] = {
  ...
  {ERR_INVALID_CONSTANT_CHAR, "Invalid char constant or string."}, // TODO: Sửa lại lỗi
  ...
  {ERR_UNDECLARED_INT_CONSTANT, "Undeclared integer constant or double constant."},   // TODO: Sửa lại lỗi
  ...
  {ERR_INVALID_DOUBLE, "A double number excepted."},   // TODO: thêm lỗi double
  {ERR_ASSIGN_MULTI_VAR_LEFT, "Assignment multiple variable has error on the left side."}, //TODO: lỗi gán nhiều phần tử
  {ERR_ASSIGN_MULTI_VAR_RIGHT, "Assignment multiple variable has error on the right side."} //TODO: lỗi gán nhiều phần tử
};
